package com.devteamvietnam.generator.domain;
...
public class GenTableColumn extends BaseEntity
{
    ...
    /** Display type (input text box, textarea text field, select drop-down box, checkbox checkbox, radio radio button, datetime date control, editor rich text control) */
